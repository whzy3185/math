...
description: Use when doing long-horizon theorem research in a repository: mining papers or remarks, attacking or strengthening problems, auditing novelty, formalizing proofs, or escalating a manuscript. Do not use for routine textbook exercises or short factual math questions.
---
...
- Falsify vulnerable or stronger claims before long proof investment; re-check prior art after material theorem upgrades.
...
- Simulated review is not peer review. Turn mathematical objections into mathematical obligations before defensive prose.
- Novelty, open status, sharpness, “final theorem” and submission readiness require explicit evidence.

## Route

- **Paper/PDF/Remark:** use it as Seed 0; extract exact statement, hypotheses, local references and limitations; read [literature](references/literature.md).
...
`P0 correctness` > `P1 cheap falsification` > `P2 novelty/provenance` > `P3 proof bottleneck` > `P4 strengthening` > `P5 Lean/exact verification` > `P6 manuscript/referee` > `P7 packaging after freeze`.
...
Maintain only needed control files, typically `RESEARCH_STATE.md`, `CLAIM_LEDGER.md`, `PROOF_GRAPH.md`, `HANDOFF.md`; add literature/referee/verification files when relevant.
...
Done means current provenance, honest evidence, closed dependencies, attempted strengthening, justified proof-critical computation, requested formal build, aligned manuscript claims, explicit residual risks, and enough repository state for immediate continuation.
