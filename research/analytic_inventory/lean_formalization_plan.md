...
|---|---|---|---|
| L1 | finite Hamilton-gauge realization | exact matrix equality for every \(n=8L\) and both holonomies | open |
...
| L4 | polynomial certificate | \(P(y,c)>0\) for \(y\ge1561/200,\ c\le2\) | started |
