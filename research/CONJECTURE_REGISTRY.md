...
| C029 | Spectral graph theory | Signed circulant global optimizer | S14 | 2026 | DISPROVED — n=32 MINIMAL; PERIOD8 SHARP CONSTANT PROVED | signed graph | even n | low-medium | very high | all even n=8..30 verified true; n=32 exact counterexample; false for every 8\|n, n≥32 | exhaustive finite proof + independent family audit + exact period-8 band edge | 18 | Target A—period-8 pattern classification next | sharp phase constant `rho_*^2=4+sqrt(10+2sqrt(5))`; no global optimality claim |
