...
| C029 | Spectral graph theory | Signed circulant global optimizer | S14 | 2026 | DISPROVED — n=32 MINIMAL; PERIOD8 STRUCTURAL MECHANISM PROVED | signed graph | even n | low-medium | very high | all even n=8..30 verified true; n=32 exact counterexample; false for every 8\|n, n≥32 | exhaustive finite proof + independent family audit + 18-orbit classification + closed-walk/chiral structural reproof | 18 | Target A—Task 41 novelty/priority audit | period-8 eight-barrier trichotomy proved; no all-period or finite-size global claim |
