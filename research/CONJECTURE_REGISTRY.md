...
| C029 | Spectral graph theory | Signed circulant global optimizer | S14 | 2026 | DISPROVED — n=32 MINIMAL; LOW-PERIOD FRONTIER PROVED; NOVELTY AUDITED | signed graph | even n | low-medium | very high | all even n=8..30 verified true; n=32 exact counterexample; false for every 8\|n, n≥32 | exhaustive finite proof + independent family audit + arbitrary-period moment obstructions + structurally compressed frontier + 135-query public-prior audit | 18 | Target A—Lane R summary; Reviewer Zero gate | no direct public prior found within recorded audit; N6 close prior and N8–N10 related methods recorded; no all-period claim |
