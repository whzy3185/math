...
> 2026-09-05导航说明：本表保留历史候选编号与当时状态。C029等行中的
> “当前阶段”“稿件未开始”和检索结论不是当前投稿状态；请先读
> [现研究入口](README.md)与[成果索引](repository_guide/RESULTS_INDEX.md)。
> 下面“唯一状态索引”是历史工作流程描述，现由上述索引补充和限定。
...
| C029 | Spectral graph theory | Signed circulant global optimizer | S14 | 2026 | DISPROVED — n=32 MINIMAL; TARGET_A_MANUSCRIPT_READY | signed graph | even n | low-medium | very high | all even n=8..30 verified true; n=32 exact counterexample; false for every 8\|n, n≥32 | exhaustive finite proof + fresh n=24..30 regeneration + independent family audit + arbitrary-period moment obstructions + structurally compressed frontier + 135-query public-prior audit | 18 | Target A—Task 44 manuscript drafting | Reviewer Zero round 2 has 0 critical/major; four open nonblocking repairs and two accepted computation-trust risks remain before submission; no all-period claim; manuscript not started |
