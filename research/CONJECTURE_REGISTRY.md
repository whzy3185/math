...
| C029 | Spectral graph theory | Signed circulant global optimizer | S14 | 2026 | DISPROVED — n=32 MINIMAL; UNIQUE PRIMITIVE OPTIMUM THROUGH PERIOD 16 | signed graph | even n | low-medium | very high | all even n=8..30 verified true; n=32 exact counterexample; false for every 8\|n, n≥32 | exhaustive finite proof + independent family audit + arbitrary-period moment obstructions + 2626-orbit low-period exact frontier | 18 | Target A—Task 42C structural compression; Task 41 audit parallel | period-8 target unique for primitive tau period≤16; no period≥17, all-period, or finite-size global claim |
