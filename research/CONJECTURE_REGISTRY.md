...
| C029 | Spectral graph theory | Signed circulant global optimizer | S14 | 2026 | DISPROVED — n=32 MINIMAL; UNIQUE PERIOD8 OPTIMUM PROVED | signed graph | even n | low-medium | very high | all even n=8..30 verified true; n=32 exact counterexample; false for every 8\|n, n≥32 | exhaustive finite proof + independent family audit + complete 18-orbit period-8 classification | 18 | Target A—Task 40C structural theorem package | unique period-8 minimizer; unique runner-up `Q=(-)^8`; no all-period or finite-size global claim |
