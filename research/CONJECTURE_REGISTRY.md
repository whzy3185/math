...
| C029 | Spectral graph theory | Signed circulant global optimizer | S14 | 2026 | DISPROVED — n=32 MINIMAL; PAPER PACKAGE READY | signed graph | even n | low-medium | very high | all even n=8..30 verified true; n=32 exact counterexample; false for every 8\|n, n≥32 | exhaustive finite proof + fresh n=24..30 regeneration + independent family audit + arbitrary-period moment obstructions + structurally compressed frontier + 135-query public-prior audit | 18 | Target A—Reviewer Zero; dependency graph; proof compression | no reproduction mismatch and no direct public prior found within recorded audit; N6 close prior and N8–N10 related methods recorded; no all-period claim; manuscript not started |
