...
| C029 | Spectral graph theory | Signed circulant global optimizer | S14 | 2026 | DISPROVED — n=32 MINIMAL; GENERAL-PERIOD MOMENT OBSTRUCTIONS PROVED | signed graph | even n | low-medium | very high | all even n=8..30 verified true; n=32 exact counterexample; false for every 8\|n, n≥32 | exhaustive finite proof + independent family audit + period-8 classification + arbitrary-period closed-walk obstructions | 18 | Target A—Task 42B low-period frontier; Task 41 audit parallel | `R<=8` forces density and local-cluster inequalities; no sufficiency, all-period optimum, or finite-size global claim |
