...
| C029 | Spectral graph theory | Signed circulant global optimizer | S14 | 2026 | DISPROVED — n=32 MINIMAL; LOW-PERIOD STRUCTURAL FRONTIER PROVED | signed graph | even n | low-medium | very high | all even n=8..30 verified true; n=32 exact counterexample; false for every 8\|n, n≥32 | exhaustive finite proof + independent family audit + arbitrary-period moment obstructions + structurally compressed 2626-orbit frontier | 18 | Target A—Task 41 synchronization; Lane R reproduction | period-8 target unique for primitive tau period≤16; 2611 moment exclusions + 8 baseline reps + 5 residual certificates; no all-period claim |
