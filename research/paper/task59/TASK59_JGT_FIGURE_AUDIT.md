...
- Overlap, clipping, text beyond margins, broken panels, and unreadable line
  encodings: none.
- Figure 3 and Figure 4 occupy consecutive identified pages; Figure 4 remains
  before Proposition 6.1 and does not interrupt its proof.
