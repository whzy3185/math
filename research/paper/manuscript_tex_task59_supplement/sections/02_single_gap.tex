...
The comparisons for these six witnesses are collected in
\cref{tab:small-gap-margins}.  The third column is the raw integer from
\eqref{eq:Delta}; the last column is the reduced or partially reduced
difference from \(T\).

\begin{table}[htbp]
\centering
\small
\caption{Small-gap Rayleigh comparisons.}
