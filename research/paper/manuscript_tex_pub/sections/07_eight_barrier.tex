\section{The Eight-Barrier and Structural Optimum}\label{sec:eight-barrier}
...
On the unit circle \(C=B*\). Equation~\eqref{eq:off-diagonal-square} explains the even characteristic
