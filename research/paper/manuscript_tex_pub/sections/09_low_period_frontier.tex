\section{Low-Period Spectral Classification}\label{sec:low-period-frontier}
...
equivalences proved in Lemmas~\ref{lem:operator-equivalences}
and~\ref{lem:zone-folding}.
...
The theorem asserts only the exact strict comparison of every non-target
competitor with \(\eta\); it makes no numerical ordering claim among those
competitors.
