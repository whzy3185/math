...
| T11 failures `48<=n<240` | 96 full-matrix LDL rows | one row per structured witness | four residue-family theorems | transfer powers/Chebyshev/finite-rank determinants | ANALYTIC_WITH_FINITE_BASE_CASES (45 rows remain) |
